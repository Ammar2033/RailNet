...
class Rail:
    ...
    def from_value(cls, rail_id: int, dtype: str, value: Any, metadata: dict | None = None) -> "Rail":
        ...
        return cls(id=rail_id, dtype=dtype, encoded_value=int(bits), decoded_value=float(decoded), metadata=metadata or {})
    ...
    def to_dict(self) -> dict:
        return {"id": self.id, "dtype": self.dtype, "bits": self.encoded_value, "value": self.decoded_value}
